-- Update config with real data from craft-data.ts

-- Real pool addresses from Ronin network
...
WHERE section = 'productionChains';

-- Default banners (empty but with proper structure - users configure via admin panel)
UPDATE app_config SET data = '[
  {"id": "top", "position": "top", "enabled": false, "imageUrl": "", "linkUrl": "", "altText": "Banner Superior", "adScript": ""},
  {"id": "between", "position": "between", "enabled": false, "imageUrl": "", "linkUrl": "", "altText": "Banner Intermedio", "adScript": ""},
