-- Fix all config sections with real data from config.json

-- Update pools with real addresses
...
}'::jsonb WHERE section = 'pools';

-- Update productionCosts with real data
UPDATE app_config SET data = '{
...
}'::jsonb WHERE section = 'productionCosts';

-- Update alertsConfig with real data
UPDATE app_config SET data = '{
...
}'::jsonb WHERE section = 'alertsConfig';

-- Update productionChains with real data
UPDATE app_config SET data = '[
  {"symbol":"EARTH","children":[{"symbol":"MUD","children":[{"symbol":"CLAY","children":[{"symbol":"SAND","children":[{"symbol":"COPPER","children":[{"symbol":"STEEL","children":[{"symbol":"SCREWS","children":[{"symbol":"ACID","children":[]}]},{"symbol":"SULFUR","children":[]}]},{"symbol":"STONE","children":[]}]},{"symbol":"GLASS","children":[{"symbol":"FIBERGLASS","children":[{"symbol":"DYNAMITE","children":[]}]}]}]},{"symbol":"CERAMICS","children":[{"symbol":"CEMENT","children":[{"symbol":"PLASTICS","children":[]}]}]}]}]}]},
...
]'::jsonb WHERE section = 'productionChains';

-- Update banners with real data
UPDATE app_config SET data = '[
  {"id":"top","position":"top","enabled":false,"imageUrl":"","linkUrl":"","altText":"Banner topo","adScript":""},
  {"id":"sidebar","position":"sidebar","enabled":false,"imageUrl":"","linkUrl":"","altText":"Banner lateral","adScript":""},
  {"id":"between","position":"between","enabled":false,"imageUrl":"","linkUrl":"","altText":"Banner entre seccoes","adScript":""}
]'::jsonb WHERE section = 'banners';

-- Update customization with real data
UPDATE app_config SET data = '{
  "headerLogo": "",
  ...
  "loginCredits": ""
}'::jsonb WHERE section = 'customization';

-- Update sharing with real data
UPDATE app_config SET data = '{
  "twitter": {
    "enabled": false,
    "apiKey": "",
    ...
    "accessSecret": "",
    "minDeviation": 30,
    "hashtags": "CraftWorld,Ronin,GameFi,Play2Earn",
    "template": "SIGNAL_TYPE SIGNAL_SYMBOL | Desvio: DEVIATION% | Preco: PRICE | #CraftWorld"
  },
  "telegramChannels": {
    "enabled": false,
    "chatIds": [],
    "minDeviation": 25,
    "template": "SIGNAL_ICON SIGNAL_TYPE SIGNAL_SYMBOL\nPreco: PRICE | Custo: COST\nDesvio: DEVIATION%"
  }
}'::jsonb WHERE section = 'sharing';

-- Update thresholds
UPDATE app_config SET data = '{"buy": 15, "sell": 20}'::jsonb WHERE section = 'thresholds';
