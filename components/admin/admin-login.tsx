...
import { Lock, ArrowLeft, User, AlertCircle, CheckCircle2 } from "lucide-react"
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {showUsername && (
                <div className="flex flex-col gap-2 animate-in slide-in-from-top-2 duration-200">
                  <Label htmlFor="username" className="text-xs font-semibold text-card-foreground">
                    {t("login.username")}
                  </Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      autoFocus
                      className="bg-secondary border-border text-card-foreground pl-10 h-10"
                    />
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="password" className="text-xs font-semibold text-card-foreground">
                  {t("login.password")}
                </Label>
                <div className="relative">
              ...
              {/* Error Alert */}
              {error && (
                <div className="flex items-center gap-2 rounded-lg border border-destructive/30 bg-destructive/5 px-3 py-2 text-xs text-destructive animate-in slide-in-from-top-2">
              ...
              {/* Success Alert */}
              {success && (
                <div className="flex items-center gap-2 rounded-lg border border-primary/30 bg-primary/5 px-3 py-2 text-xs text-primary animate-in slide-in-from-top-2">
                  <CheckCircle2 className="h-4 w-4 shrink-0" />
                  <span>Autenticação bem-sucedida...</span>
                </div>
              )}
              ...
              <button
                ...
                className="text-xs text-muted-foreground hover:text-foreground transition-colors text-center py-1 rounded hover:bg-secondary"
              >
